...
function NavBar(){
    ...
    return(
        <>
        <nav className=" nav-bar w-full block items-center py-4 px-16 justify-end fixed z-20" style={{ backgroundColor: 'rgba(11, 11, 14, 0.8)' }}>
...
<img src={dcLogo} alt="Logo" className="h-0 w-auto lg:h-12 lg:w-auto mr-4" />
  </div>
  <div className="w-full flex-row lg:flex lg:items-center lg:w-auto float-right">
    ...
    <div className="text-sm flex lg:flex-row justify-center items-center float-right">
      <a href="#Home" className="block mt-4  lg:mt-0 text-white hover:text-primaryLightBlue mr-4">
        Home
      </a>
