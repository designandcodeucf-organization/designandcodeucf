...
function OfficerCarousel () {
  ...
  return (
    ...
    <h2 className='text-[4.2rem]'>Meet Our Officers:</h2>
      ...
      <div
        key={item.id}
        className='w-[52rem] h-[45rem] xs:w-[26rem] xs:h-[150rem] sm:w-[25rem] sm:h-[15rem] md:w-[30rem] lg:w-[356px] xl:w-[33rem] inline-block p-8 cursor-pointer hover:scale-105 ease-in-out duration-300 rounded-full'
...
{selectedMember && (
  <div className='pop-up-background fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center bg-black bg-opacity-75' onClick={closePopup}>
    ...
    <div className='pop-up-box xs:w-[40rem] xs:h-[625px] sm:w-[50rem] sm:h-[625px] md:w-[55rem] md:h-[625px] lg:w-[70rem] lg:h-[625px] bg-primaryDarkBlue xs:py-2 xs:px-4 sm:py-8 sm:px-16 rounded-lg'  >
      <img
        src={selectedMember.img} 
        alt={selectedMember.name}
        className='w-[20rem] h-[20rem] xs:w-[125px] xs:h-[125px] sm:w-[125px] sm:h-[125px] md:w-[15rem] md:h-[15rem] object-cover rounded-full mx-auto mb-4'
      />
