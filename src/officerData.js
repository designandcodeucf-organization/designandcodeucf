...
export const data = [
	{
		...
		minor: "Spanish",
		description:
			"Meera's primarily interested in front-end development and her favorite framework right now is Bootstrap CSS. She has an interest in space and the effort it takes to achieve deep space exploration. In her free time she enjoys playing pickleball, reading, video games, and spending time with family and friends.",
		socials: "Where to reach Meera:",
		icons: [
			{
				socialName: "LinkedIn",
				link: "https://www.linkedin.com/in/meera-bhola/",
			},
	...
	},
	{
		...
		icons: [
			{
				socialName: "LinkedIn",
				link: "https://www.linkedin.com/in/valeria-tibocha/",
			},
	...
	},
	{
		...
		icons: [
			{
				socialName: "LinkedIn",
				link: "https://www.linkedin.com/in/alysonfranco/",
			},
	...
	},
	{
		...
		minor: "Computer Science",
		description:
			"Dynie likes to craft and go out on nature walks. She is graduating this Fall semester. Her favorite framework is React!",
		socials: "Where to reach Dynie:",
		icons: [
			{
				socialName: "LinkedIn",
				link: "https://www.linkedin.com/in/dyniem/",
			},
			{ socialName: "GitHub", link: "" },
